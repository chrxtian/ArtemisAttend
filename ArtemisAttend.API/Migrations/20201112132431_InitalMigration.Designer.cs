...
namespace ArtemisAttend.API.Migrations
{
    ...
    [Migration("20201112132431_InitalMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtemisAttend.API.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ArtemisAttend.API.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ArtemisAttend.API.Entities.Course", b =>
                {
                    b.HasOne("ArtemisAttend.API.Entities.Author", "Author")
                        .WithMany("Courses")
